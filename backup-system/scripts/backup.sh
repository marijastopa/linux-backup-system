...
# Function to send email notification (macOS)
send_email() {
    local status="$1"
    local message="$2"
...
# Function to rotate old backups (macOS compatible)
rotate_backups() {
    ...
    # Find and delete backups older than retention period (macOS find syntax)
